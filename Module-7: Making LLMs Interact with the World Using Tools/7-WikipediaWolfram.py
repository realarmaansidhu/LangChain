# Langchain Code to implement an AI Agent with Wolfram Alpha and Wikipedia using Grok's LLM
import requests
import os
...
wikipedia_tool = load_tools(["wikipedia"], llm=llm, description="Useful for looking up information on Wikipedia")

all_tools = [wolfram_tool] + wikipedia_tool

agent = initialize_agent(llm=llm, tools=all_tools, agent=AgentType.ZERO_SHOT_REACT_DESCRIPTION, verbose=True, description="An AI agent that uses Wolfram Alpha and Wikipedia to answer questions.")
